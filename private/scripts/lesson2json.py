...
with open("json_lesson_loader.json", "w") as loader:
	json.dump(all_lessons, loader, indent=4)

with open("json_set_loader.json", "w") as loader:
	json.dump(all_sets, loader, indent=4)

with open("json_group_loader.json", "w") as loader:
	json.dump(all_groups, loader, indent=4)

with open("json_word_loader.json", "w") as loader:
