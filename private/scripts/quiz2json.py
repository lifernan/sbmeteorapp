...
url = "https://raw.githubusercontent.com/lifernan/sbsound/master/american_english/quiz_sentences"
path = "/Users/lifernan/Desktop/sbsound/american_english/quiz_sentences/"
extension = '.wav'
...
for lesson in lessons:
	...
	for sentence_filename in sentences:
		...
		all_sentences.append({'quiz': lesson_number, 'gender': gender, 'sentence': sentence, \
			'url': join(url, lesson, sentence_filename)})
